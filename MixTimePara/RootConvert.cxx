...
int main(int argc, char *argv[]){
	  ...
	  double time1,time2;
	  float S,theta;
	  float sourcePosX1,sourcePosY1,sourcePosZ1,sourcePosX2,sourcePosY2,sourcePosZ2;

	  int co,nComP1,nComP2,nComC1,nComC2,nRayP1,nRayP2,nRayC1,nRayC2;
	  int A1,A2,T1,T2;
	  int Adc1 ,Adc2;
	  double  Tdiff,Tdiffraw;   //UNIT  : keV, keV, ns;
	  float mS,mtheta;
	  float sx1,sx2,sy1,sy2,sz1,sz2;
      int Ax1,Ax2,Tx1,Tx2;
	  int xadc1,xadc2;
	  double xtdiff;
	  ...
	  ch->SetBranchAddress("sourcePosX1",    &sourcePosX1);
	  ch->SetBranchAddress("sourcePosY1",    &sourcePosY1);
	  ch->SetBranchAddress("sourcePosZ1",    &sourcePosZ1);
	  ch->SetBranchAddress("sourcePosX2",    &sourcePosX2);
	  ch->SetBranchAddress("sourcePosY2",    &sourcePosY2);
	  ch->SetBranchAddress("sourcePosZ2",    &sourcePosZ2);
      ...
      sprintf(buf,"%s/Timeparameter.root",filepath2.c_str());
	  TFile *f=new TFile(buf);
	  TTree *tr=(TTree*)f->Get("tr");
	  tr->SetBranchAddress("timepar", &timepar);
      tr->GetEntry(0);

	  sprintf(buf,"%s/CoinwithTimepar.root",filepath2.c_str());
	  ...
	  tree->Branch("Tdiffraw", &Tdiffraw,"Tdiffraw/D");
	  ...
	  tree->Branch("sx1",    &sx1,   "sx1/F");
	  tree->Branch("sy1",    &sy1,   "sy1/F");
	  tree->Branch("sz1",    &sz1,   "sz1/F");
	  tree->Branch("sx2",    &sx2,   "sx2/F");
	  tree->Branch("sy2",    &sy2,   "sy2/F");
	  tree->Branch("sz2",    &sz2,   "sz2/F");
