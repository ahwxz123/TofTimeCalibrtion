...
int main(int argc, char *argv[]){
	  ...
	  char buf[200];
	  int eventID1,rsectorID1,moduleID1,submoduleID1,crystalID1,layerID1,comptonPhantom1;
	  int eventID2,rsectorID2,moduleID2,submoduleID2,crystalID2,layerID2,comptonPhantom2;
	  ...
	  sprintf(buf,"%s/RawCoinwithTimepar.root",filepath2.c_str());
