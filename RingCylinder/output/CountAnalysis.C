...
//  
   ...
   ULong64_t nbytes = 0, nbytesdelay = 0,nprompt=0, nrandom = 0, nscatter = 0, ntrue = 0, count = 0,d=1;
...
//
   ...
   for (ULong64_t i=0; i<nentries;i++)
  {
     ...
     if (eventID1 != eventID2) { // Random coincidence
       ...
       if (comptonPhantom1 == 0 && comptonPhantom2 == 0 &&RayleighPhantom1 == 0 && RayleighPhantom2 == 0) ntrue++;
   ...
   cout << endl << endl;
   cout << " There are " << ntrue << " true unscattered coincidences  "<<ntrue*100./nentries <<"%  "<<endl;
   cout << " There are " << nrandom << " random coincidences " <<nrandom*100./nentries<<"%"<< endl;
   cout << " There are " << nscatter << " scattered coincidences" <<nscatter*100./nentries<<"%"<< endl;
